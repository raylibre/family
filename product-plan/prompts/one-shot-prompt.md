...
- **@product-plan/design-system/** — Color tokens, typography, and font setup
- **@product-plan/data-shapes/** — UI data contracts (the shapes of data the components expect)
- **@product-plan/shell/** — Application shell components and README
...
2. **Authentication & users** — How users should sign up, log in, and what permissions exist (admin vs. family vs. donor roles)
3. **UVR integration** — How to verify UVR codes against the Ukrainian Military Movement registry
4. **Email** — What email provider to use for the partnership inquiry confirmation
