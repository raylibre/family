...
import type { FamilyCategory, Locale } from '../types'
...
export function FamilyDashboard({
  ...
  function handleSubmit(e: React.FormEvent) {
    e.preventDefault()
    onSubmit?.({ familyName, story, memberName, memberRank, frontLineConfirmed: frontLine, children, selectedNeeds, customNeed, categoryId: selectedCategoryId })
    setSubmitted(true)
    setEditing(false)
  }
